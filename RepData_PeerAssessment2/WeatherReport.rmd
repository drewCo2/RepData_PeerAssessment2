...
stormData<-mutate(stormData, CropDamage= PROPDMG * getMultipliers(CROPDMGEXP))
...
Some of the EVTYPE entries are typos so we will clean up that factor.  Looking at a sorted list of the factor
